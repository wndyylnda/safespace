 ...
 <section class="section active">
            <!-- Hero Section -->
            <div class="bg-gradient-to-r from-primary to-secondary text-white py-12 sm:py-16 lg:py-20 xl:py-24">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div class="flex flex-col xs:flex-row gap-3 sm:gap-4 justify-center items-center max-w-md xs:max-w-none mx-auto">
                        <button onclick="showSection('education')" class="w-full xs:w-auto bg-white text-primary px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors text-sm sm:text-base">Pelajari Lebih Lanjut</button>
                        <button onclick="showSection('support')" class="w-full xs:w-auto border-2 border-white text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold hover:bg-white hover:text-primary transition-colors text-sm sm:text-base">Butuh Bantuan?</button>
                    </div>
                </div>
            </div>
            ...
            <div class="py-12 sm:py-16 bg-white">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center">
                        ...
                        <div class="p-4 sm:p-6">
                            <div class="text-3xl sm:text-4xl font-bold text-primary mb-2">50+</div>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        <div class="bg-white p-6 sm:p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                            <div class="text-primary text-3xl sm:text-4xl mb-4">📚</div>
